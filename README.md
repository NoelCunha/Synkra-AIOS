...
### AIOS Chat UI - Interface Visual

O Synkra AIOS inclui uma interface de chat visual moderna para interagir com o Claude Code CLI.

> **Desenvolvido por [Pressa Digital](https://portfolio.pressadigital.com.br/)** - Interface visual criada para facilitar a interacao com agentes IA.

![AIOS Chat UI](assets/chat-ui-screenshot.png)

**Recursos:**
- Interface visual moderna e intuitiva
- Streaming em tempo real das respostas
- Historico de conversas persistente
- Sugestoes de prompts rapidos
- Indicador de conexao em tempo real
- Suporte a diretorio de trabalho personalizado

**Para iniciar o Chat UI:**
```bash
cd apps/chat-ui
npm install
npm run dev
...
*Copyright (c) 2025 Pressa Digital - Todos os direitos reservados.*

### Inicio Mais Rapido com Interface Web (2 minutos)

1. **Instale o AIOS**: Execute `npx aios-core init meu-projeto`
2. **Configure seu IDE**: Siga as instrucoes de configuracao para Codex CLI, Cursor ou Claude Code
3. **Comece a Planejar**: Ative um agente como `@analyst` para comecar a criar seu briefing
4. **Use comandos AIOS**: Digite `*help` para ver comandos disponiveis
5. **Siga o fluxo**: Veja o [Guia do usuario](docs/guides/user-guide.md) para mais detalhes
